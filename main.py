...
data_hex_files.gen_common_hex_file(number_hex_file=2, empty=0xF0)
data_hex_files.gen_region_hex_file(data_hex_files.gen_region(number_hex_file=0, number_region=5))
