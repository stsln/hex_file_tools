...
"}")
        ...
        self.verticalLayout_7.addWidget(self.message_label, 0, QtCore.Qt.AlignmentFlag.AlignTop)
...
"}")
    ...
    def retranslateUi(self, Main):
        ...
        self.lable_ofs_and_file.setText(_translate("Main", "Смещение региона, файла ..."))
